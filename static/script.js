/* -----------------------------------------------------------------------
   ...
   Dataset now syntactically complete (stops at Rhodium but script runs)
   -------------------------------------------------------------------- */

/* ---------- colour map ---------------------------------------------- */
const STATE_COLOUR = { solid:"#90be6d", liquid:"#8ecae6", gas:"#ffd93b", unknown:"#adb5bd" };

/* ---------- element data (H ➜ Rh for demo) -------------------------- */
const ELEMENTS = [
  /* period 1 */
  ...
  {sym:"Cr", name:"Chromium", num:24, mass:51.996, state:"solid",row:4,col:6,  ref:"Stainless steel rust resistance."},
